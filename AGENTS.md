...
**Hisabati: Kitabu cha Mwanafunzi Darasa la Tano** — Hiki ni kitabu cha Hisabati cha mwanafunzi wa Darasa la Tano kilichoandaliwa na Taasisi ya Elimu Tanzania kwa wanafunzi wa shule za msingi Tanzania Bara, hivyo kinalenga kiwango cha elimu ya msingi ya kati. Kimeandikwa kwa Kiswahili na kinashughulikia mada kama vipimo, mzingo na eneo la duara, aina za namba, sehemu, desimali, aljebra na hesabu za fedha. Mtazamo wake wa ufundishaji ni wa vitendo na hatua kwa hatua, ukitumia mifano ya maisha ya kila siku, mazoezi mengi, michoro na kazi za kufanya ili kukuza umahiri wa kutatua matatizo kwa mantiki.
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha Jamhuri ya Muungano wa Tanzania, Wizara ya Elimu, Sayansi na Teknolojia, kinachoidhinisha kitabu cha Hisabati Kitabu cha Mwanafunzi Darasa la Tano, kikiwa na namba 2053, tarehe 31 Mei 2025, na sahihi ya Kamishna wa Elimu.",
  "gl001": "akaunti",
  "gl001_def": "Mahali au mfumo wa kuhifadhi na kutumia fedha benki au taasisi ya fedha."
}
```
...
```json
{
  "akaunti": {
    "word": "akaunti",
    "definition": "Mahali au mfumo wa kuhifadhi na kutumia fedha benki au taasisi ya fedha.",
    "variations": ["akaunti","akaunti yake","akanti"],
    "emoji": "🏦📒"
  }
}
```
